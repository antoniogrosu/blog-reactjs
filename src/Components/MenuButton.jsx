...
function MyDropdown() {
  return (
    <Menu>
      ...
      <Menu.Items className="text-center text-lg grid columns-1 py-6 justify-center gap-6 lato font-semibold w-full absolute left-0 top-32 bg-brown text-orange-200">
        <Menu.Item>
          {({ active }) => (
